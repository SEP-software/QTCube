...
class mouse_func{
  ...
  void do_noth(std::vector<slice*> slices, int islice, int ix, int iy, orient_cube *pos, std::vector<QString> *com, draw_other *draw_o);
    void redraw_it(std::vector<slice*> slices, int islice, int ix, int iy, orient_cube *pos, std::vector<QString> *com, draw_other *draw_o);
...
void line_move(std::vector<slice*>slices,int islice, int ix,int iy, orient_cube *pos, std::vector<QString> *com, draw_other *draw_o);
void hyper_move(std::vector<slice*>slices,int islice, int ix,int iy, orient_cube *pos, std::vector<QString> *com, draw_other *draw_o);
...
void add_multi_picks(std::vector<slice*>slices,int islice, int ix,int iy, orient_cube *pos, std::vector<QString> *com, draw_other *draw_o);
void delete_multi_picks(std::vector<slice*>slices,int islice, int ix,int iy, orient_cube *pos, std::vector<QString> *com, draw_other *draw_o);
