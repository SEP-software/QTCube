...
class view{
  ...
  public:
    ...
    virtual std::vector<QString> right_mouse_release(float x, float y, orient_cube *pos,mouse_func *mode){
      return r_mouse_r_view(x,y,pos,mode);
    }
    virtual std::vector<QString> right_mouse_move(float x, float y, orient_cube *pos,mouse_func *mode){
      return r_mouse_m_view(x,y,pos,mode);
    }
    virtual std::vector<QString> right_mouse_down(float x, float y, orient_cube *pos,mouse_func *mode){
      return r_mouse_d_view(x,y,pos,mode);
    }
    //MID
    virtual std::vector<QString> mid_mouse_release(float x, float y, orient_cube *pos,mouse_func *mode){
      return m_mouse_r_view(x,y,pos,mode);
    }
    virtual std::vector<QString> mid_mouse_move(float x, float y, orient_cube *pos,mouse_func *mode){
      return m_mouse_m_view(x,y,pos,mode);
    }
    virtual std::vector<QString> mid_mouse_down(float x, float y, orient_cube *pos,mouse_func *mode){
      return m_mouse_d_view(x,y,pos,mode);
    }
    //LEFT
        virtual std::vector<QString> left_mouse_down(float x, float y, orient_cube *pos,mouse_func *mode){
      return l_mouse_d_view(x,y,pos,mode);
    }
    virtual std::vector<QString> left_mouse_release(float x, float y, orient_cube *pos,mouse_func *mode){
      return l_mouse_r_view(x,y,pos,mode);
    }
    virtual std::vector<QString>  left_mouse_move(float x, float y, orient_cube *pos,mouse_func *mode){
      return l_mouse_m_view(x,y,pos,mode);
    }
            virtual std::vector<QString>  right_mouse_double(float x, float y, orient_cube *pos,mouse_func *mode){
      return r_mouse_double_view(x,y,pos,mode);
    }
            virtual std::vector<QString>  mid_mouse_double(float x, float y, orient_cube *pos,mouse_func *mode){
      return m_mouse_double_view(x,y,pos,mode);
    }
    
        virtual std::vector<QString>  left_mouse_double(float x, float y, orient_cube *pos,mouse_func *mode){
   ...
   std::vector<QString> r_mouse_d_view(float x, float y, orient_cube *pos, mouse_func *mode);
    std::vector<QString> r_mouse_m_view(float x, float y, orient_cube *pos, mouse_func *mode);
   std::vector<QString> r_mouse_r_view(float x, float y, orient_cube *pos, mouse_func *mode);
    ...
    virtual void resize_view_end(int ix,int iy){if(ix==iy){;};} 
     ...
     std::vector<QString> m_mouse_d_view(float x, float y, orient_cube *pos, mouse_func *mode);
  std::vector<QString> m_mouse_m_view(float x, float y, orient_cube *pos, mouse_func *mode);
    std::vector<QString> m_mouse_r_view(float x, float y, orient_cube *pos, mouse_func *mode);
   ...
   std::vector<QString> l_mouse_d_view(float x, float y, orient_cube *pos, mouse_func *mode);
    std::vector<QString> l_mouse_m_view(float x, float y, orient_cube *pos, mouse_func *mode);
   std::vector<QString> l_mouse_r_view(float x, float y, orient_cube *pos, mouse_func *mode);
    ...
    virtual std::vector<QString> l_mouse_double_view(float x, float y, orient_cube *pos, mouse_func *mode);
   virtual  std::vector<QString> m_mouse_double_view(float x, float y, orient_cube *pos, mouse_func *mode);
    virtual std::vector<QString> r_mouse_double_view(float x, float y, orient_cube *pos, mouse_func *mode);
