...
class part_semb_data_byte:public partial_data_byte{
   ...
   public:
     ...
     part_semb_data_byte(){};
     part_semb_data_byte(std::string title,QString nm,std::shared_ptr<hypercube>g,std::shared_ptr<io_func>i, int i_t,int i_off, int i_mes,
       std::shared_ptr<pick_draw>pk,QString s1, QString s2,std::shared_ptr<paramObj>p, int in,int im=1);
      ~part_semb_data_byte(){};
