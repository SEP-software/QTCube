...
std::shared_ptr<picks_vec> picks_new::get_parse_picks(QString col, int type,
                                                      int extra, QString t) {
...
void picks_new::get_parse_picks(std::shared_ptr<picks_vec> buck, QString col,
                                int typ, int extra, QString t) {
